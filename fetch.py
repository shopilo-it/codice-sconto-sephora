#!/usr/bin/env python3
"""
Recupero codici sconto Sephora da shopilo.it
Sursa: https://shopilo.it/negozi/sephora.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/sephora.it"
STORE_NAME = "Sephora"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Sephora da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-sephora)"
    }
    try:
